...
import { SlidersHorizontal, Eraser, X, Mail, Instagram, Twitter, Youtube } from 'lucide-react';
...
const Index = () => {
  ...
  // Fetch available filters based on subcategory + genre
  useEffect(() => {
    ...
    if (subCatSelected || genre) getFilters();
  }, [subCatSelected, genre]);
...
useEffect(() => {
  console.log("🎨 Colors Array Detail:", availableFilters.colors);
        ...
        {FunnelIC && (
          ...
          >
            <div className="filter-header">
              <h2>Filters</h2>
              <X size={22} className="close-icon" onClick={() => setFunnel(false)} />
            </div>
