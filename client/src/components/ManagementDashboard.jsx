        ...
        <div className='ManagementDashboard-1'>
          ...
          <div className='MenuDashbord'>
            ...
            <div className='h2Dash' >
              ...
              <AlignStartVertical style={{marginLeft:"10%",color: selecteMenu === 'Users'?'white':"gray"}}/>
            ...
            <div className='h2Dash'>
              ...
              <AlignStartVertical   style={{marginLeft:"10%",color: selecteMenu === 'Orders'?'white':"gray"}}/>
            ...
            <div className='h2Dash'>
              ...
              <AlignStartVertical style={{marginLeft:"10%",color: selecteMenu === 'Categories'?'white':"gray"}}/>
            ...
            <div className='h2Dash'>
              ...
              <AlignStartVertical style={{marginLeft:"10%",color: selecteMenu === 'AllProducts'?'white':"gray"}}/>
            ...
            <div className='h2Dash' >
              ...
              <AlignStartVertical style={{marginLeft:"10%",color: selecteMenu === 'AddNewProduct'?'white':"gray"}}/>
              <Link onClick={()=>handleMenuSelect('AddNewProduct')} style={{textDecoration:"none"}} to='/ManagementDashboard/AddNewProduct'>  
                <h3 onClick={()=>handleMenuSelect('AddNewProduct')} style={{marginLeft:"5%",fontSize: selecteMenu ==="AddNewProduct"?"15px":"13px",cursor:"pointer",color: selecteMenu === 'AddNewProduct'?'white':"gray"}}>Add New Product</h3>
              </Link>
            </div>
            <div className='h2Dash'>
              <div className='clickLink' style={{display: selecteMenu === "SalesReports" ?'':"none"}}></div>
              <AlignStartVertical style={{marginLeft:"10%",color: selecteMenu === 'SalesReports'?'white':"gray"}}/>
